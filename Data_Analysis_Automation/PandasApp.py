...
dtxt = pandas.read_csv(r"C:\Udemy_Python_Masterclass\Data_Analysis_Automation\sample_data\my_employees.txt")

#Loading the CSV file for writing to a new table in the database
dcsv = pandas.read_csv(r"C:\Udemy_Python_Masterclass\Data_Analysis_Automation\sample_data\my_employees.csv")

#Loading the JSON file for writing to a new table in the database
djson = pandas.read_json(r"C:\Udemy_Python_Masterclass\Data_Analysis_Automation\sample_data\my_employees.json")

#Loading the Excel file for writing to a new table in the database
dxlsx = pandas.read_excel(r"C:\Udemy_Python_Masterclass\Data_Analysis_Automation\sample_data\my_employees.xlsx", sheet_name = 0)

#Loading an existingSQL table as a DataFrame for writing to a new table in the database
...
with open(r"C:\Udemy_Python_Masterclass\Data_Analysis_Automation\summary.html", "w") as f:
